  ...
  const RenderArrow = () => {
    return (
      <div className="slider-arrows">
        <div className="slider-arrow slider-arrow--left" onClick={() => moveSlideWithArrow('prev')}></div>
        <div className="slider-arrow slider-arrow--right" onClick={() => moveSlideWithArrow('next')}></div>
      </div>
    );
  };
